// Const/Lijst met landen en landcodes: Const met array met objecten erin. 
...
// Javascript vind de <datalist> met id=countries

const datalist = document.getElementById("countries");

// Ga door alle landen heen. Pak van elk land de naam. Maak een nieuwe option aan. Zet de waarde van die option gelijk aan de landnaam. Voeg de option toe aan de datalist.
...
// Maak een object waarin elke landnaam gekoppeld is aan een landcode. Zoek daarna de HTML-elementen van:
// - het land-inputveld
// - het landcode-inputveld
// - het tekstvak voor de landcode
// Luister vervolgens naar veranderingen in het land-inputveld.
// Wanneer de gebruiker een land kiest:
// - zoek de bijbehorende landcode
// - als die bestaat:
//     - vul de landcode automatisch in
//     - toon de landcode op het scherm
// - anders:
//     - maak alles leeg
...
//Foutmeldingen hierachie geef foutmeldingen als er een fout is
...
document.querySelector("form").addEventListener("submit", function (e) {
  ...
  // Als alles valid is krijg je melding met dat het formulier is verzonder daarna wordt alles gereset
